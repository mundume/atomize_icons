...
const SizeXs = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g clipPath="url(#a)">
      <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16Z" fill="currentColor" />
      <path
    ...
    <g clipPath="url(#b)" fillRule="evenodd" clipRule="evenodd">
      <path d="M12 8a8 8 0 1 1 16 0 8 8 0 0 1-16 0Z" fill="currentColor" />
      <path
    ...
    <defs>
      ...
      <clipPath id="b">
        <path fill="currentColor" transform="translate(12)" d="M0 0h16v16H0z" />
      </clipPath>
    </defs>
  </svg>
);
